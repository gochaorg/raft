...
pub fn queue_api_route( cfg: &mut web::ServiceConfig ) {
    cfg
     ...
     .service(plain_api::insert_text_plain)
     .service(plain_api::write_bytes_at_tail)
     .service(plain_api::write_bytes)
     .service(plain_api::read_bytes)
     .service(plain_api::header_of)
